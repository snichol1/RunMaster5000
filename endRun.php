...
<div data-role="page">
	...
	<script type="text/javascript">
		if(sessionStorage.goalTime > sessionStorage.time) {
			document.getElementById("message").textContent = "Good work, you'll reach your goal in no time!";
		}
		document.getElementById("time").textContent = "Your time was: " + sessionStorage.timePretty;
		document.getElementById("goal").textContent = "Your goal was: " + sessionStorage.goalTimePretty;
	</script>
</div>
<body>
</html>